  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
      ...
      <div className="lg:col-span-4 flex flex-col gap-6">
        {result ? (
          <div className="bg-white rounded-[20px] border border-[#E8E8E8] shadow-sm p-6 space-y-4 animate-fade-in">
            <h3 className="font-bold text-[#171C38] text-sm border-b border-[#E8E8E8] pb-2 mb-2">Proyeksi Kelayakan Finansial</h3>
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="font-bold text-emerald-600">{formatRupiah(result.margin)}</span>
              </div>
              <div className="flex justify-between items-center text-xs">
              ...
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="font-bold text-[#FF6B1A] bg-[#FF6B1A]/10 px-2 py-0.5 rounded-full">{result.roiMonths} Bulan</span>
              </div>
            </div>
            <div className="bg-emerald-500/5 border border-emerald-500/10 rounded-xl p-3 flex items-start gap-2 mt-4">
              ...
              <p className="text-[10px] text-[#6F7178] leading-normal">Margin keuntungan bersih sebesar <strong>{Math.round((result.margin / bepForm.sellingPrice) * 100)}%</strong> dari harga jual.</p>
            </div>
          </div>
        ) : (
          <div className="bg-[#F8ECD2]/30 border border-[#E8E8E8] border-dashed rounded-3xl p-6 text-center text-[#6F7178] flex flex-col items-center justify-center min-h-[150px]">
            <CalcIcon className="w-10 h-10 mb-2 stroke-[1.5]" />
            <h4 className="font-bold text-xs text-[#171C38]">Belum Ada Perhitungan</h4>
            <p className="text-[10px] text-[#6F7178] mt-0.5">Isi data dan tekan tombol hitung.</p>
          </div>
        )}
